...
public:
    ...
    static std::string generate_impl(const Args& args) {
        return fmt::format(R"(
#include <deep_gemm/impls/sm120_fp8_gemm_1d1d.cuh>

using namespace deep_gemm;

static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(&sm120_fp8_gemm_1d1d_impl<
        {}, {}, {},
        {},
        {}, {}, {},
        {}, {},
...
static void sm120_fp8_gemm_1d1d(const torch::Tensor& a, const torch::Tensor& sfa,
    ...
    const auto& tensor_map_cd = make_tma_cd_desc(d, m, n,
                                                 SM120ArchSpec::get_cd_store_block_m(config.block_m, true),
